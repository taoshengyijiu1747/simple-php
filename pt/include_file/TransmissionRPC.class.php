...
class TransmissionRPC
{
  ...
  {
    $extra_options['download-dir'] = $save_path;//365 "download-dir" | string  path to download the torrent to
  ...
  {
    return $this->request( "session-get", array('rpc-version') );
  }
  /**
  ...
  protected function request( $method, $arguments )
  {
    ...
    else if( substr( $stream_meta['wrapper_data'][0], 9, 3 ) == "409" )
